...
export type Preference = "default" | "like" | "dislike" | "none";
			...
			<div className={styles.topArea}>
				...
				<div className={styles.content}>
					<div className={styles.textArea}>
						<div className={styles.titleText}>무엇을 좋아하시나요 ?</div>
					...
					<div className={styles.foodList}>
						{foodList.map((food) => (
							<FoodSelection
								...
								imgUrl={food.imgUrl}
								preference={preferences[food.id] ?? "default"}
								setPreference={(pref) => handleSetPreference(food.id, pref)}
							/>
						))}
					</div>
				</div>
